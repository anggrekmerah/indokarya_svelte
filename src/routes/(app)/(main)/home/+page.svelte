...
<main class="flex-1 overflow-y-auto pb-20"> 
    <div class="p-4 md:p-6">
      ...
      <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100 transition-all duration-300 hover:shadow-lg"> <!-- Start Card-->
    ...
    <div class="fixed inset-0 bg-gray-900/50 backdrop-blur-sm z-40 flex items-center justify-center">
        <div class="bg-white p-4 sm:p-6 rounded-2xl shadow-2xl w-[95%] sm:max-w-md">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl sm:text-2xl font-bold text-gray-800">Check In</h2>
