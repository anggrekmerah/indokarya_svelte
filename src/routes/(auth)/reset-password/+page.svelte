<script>
    ...
    let loading = $state(false); // Gunakan $state untuk reaktivitas Svelte 5
  ...
  <div class="grid lg:grid-cols-2 min-h-screen">
    ...
    <div class="flex items-center justify-center p-4 sm:p-8">
      <div class="w-full max-w-md py-8 px-4 sm:p-8 md:p-10 bg-white dark:bg-gray-800 rounded-xl shadow-2xl transition duration-500">
        ...
        <form method="POST" action="?/resetPassword" class="space-y-8 py-8" use:enhance={handleEnhance}>
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                required
                placeholder="••••••••"
                class="w-full py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500 disabled:opacity-50"
              /> 
            </div>
