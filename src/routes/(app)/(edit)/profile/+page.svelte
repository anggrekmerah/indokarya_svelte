...
<main class="flex-1 overflow-y-auto pb-20"> 
    <div class="p-4 md:p-6">
        ...
        <h1 class="text-3xl sm:text-4xl font-bold text-gray-800 text-center mb-2">Employee Information</h1>
        <p class="text-center text-gray-500 mb-8 text-sm sm:text-base">Fill in the details to create a new employee profile.</p>
        ...
        <form>
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8 mb-8">
                ...
                <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                    ...
                    <div>
                        <label for="id" class="block text-sm font-medium text-gray-700 mb-1">Employee ID</label>
